    ...
    async execution(param: Params) {
        ...
        switch (appID) {
            ...
            case 'a':
                ...
                break;
            case 'lab16-1':
                import('./16-1_CanvasTransformation').then(({ Solution }) => { this.app = new Solution(view)});
                break;
            case 'lab17':
                break;
            case 'lab18':
        ...
        switch (appID) {
            ...
            case 'Typescript-syntax': import('./01_Typescript_Basics').then(({ Solution }) => { this.app = new Solution(containerID) }); break;
            case 'Condition-Loop': import('./02_Condition_Loop').then(({ Solution }) => { this.app = new Solution(containerID) }); break;
            case 'Data-Structure': import('./03_Data_Structure').then(({ Solution }) => { this.app = new Solution(containerID) }); break;
            case 'Function-Class': import('./04_Function_Class').then(({ Solution }) => { this.app = new Solution(containerID) }); break;
            // .....................
            case 'Exercise': import('./05_Exercise').then(({ Solution }) => { this.app = new Solution(containerID) }); break;
            default: break;
        }
    }
    public destroy() {
